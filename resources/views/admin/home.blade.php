                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="dashboard-menu">
                            <ul class="nav flex-column" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="menumakanan-tab" data-bs-toggle="tab" href="#menu" role="tab" aria-controls="menu" aria-selected="false"><i class="fi-rs-shopping-bag mr-10"></i>Menu</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="orders-tab" data-bs-toggle="tab" href="#orders" role="tab" aria-controls="orders" aria-selected="false"><i class="fi-rs-shopping-bag mr-10"></i>Orders</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="track-orders-tab" data-bs-toggle="tab" href="#track-orders" role="tab" aria-controls="track-orders" aria-selected="false"><i class="fi-rs-shopping-cart-check mr-10"></i>Add Menu</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-md-9">
                        <div class="tab-content account dashboard-content pl-50">
                            ...
                            <div class="tab-pane fade" id="menu" role="tabpanel" aria-labelledby="menumakanan-tab">
                                <div class="card">
                                    <div class="card-header">
                                            ...
                                            <div class="col-lg-8">
                                                <form class="contact-form-style mt-30 mb-50" action="{{ route('menu:store') }}" method="post">
                                                    ...
                                                    <div class="input-style mb-20">
                                                        ...
                                                        <input name="name" placeholder="Nama Makanan" type="text">
                                                    </div>
                                                    <div class="input-style mb-20">
                                                        <label>Harga</label>
